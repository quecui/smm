...
public class OAuthUser implements Serializable {
    ...
    public List<PageAccessToken> getPageAccessTokens() {
        return pageAccessTokens;
    }

    public void setPageAccessTokens(List<PageAccessToken> pageAccessTokens) {
        this.pageAccessTokens = pageAccessTokens;
    }

    @ManyToMany(mappedBy="users")
    private List<PageAccessToken> pageAccessTokens = new ArrayList<PageAccessToken>();
